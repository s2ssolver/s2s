...
//! Converts the script, represented as an AST, into the internal representation of formulas.
...
use crate::{
    ast::{
        CoreExpr, ExprType, Expression, ExpressionBuilder, IntExpr, Script, SmtCommand, Sort,
        Sorted, StrExpr, Variable,
    },
    context::Context,
};
